...
export default function ContractorPanel({ setRole }) {
    ...
    const handleLogin = async () => {
        ...
        if (res.success) {
            ...
            setLoginError(res.message || "आपकी authority suspend की गई है। कृपया Officer से संपर्क करें।");
        } else {
                        ...
                        <div className="w-full space-y-6">
                            ...
                            <div className="relative group">
                                <input
                                    ...
                                    placeholder="••••"
                                    value={tempPin}
                                    onChange={(e) => { setTempPin(e.target.value); setLoginError(null); }}
                                    maxLength={4}
                                />
                            </div>
                            ...
                            <AnimatePresence>
                                {loginError && (
                                    <motion.div
                                        ...
                                        exit={{ opacity: 0 }}
                                        className="bg-rose-500/20 border border-rose-500/40 rounded-2xl px-5 py-4 text-rose-300 text-sm font-bold text-center leading-relaxed"
                                    >
                                        🔒 {loginError}
                                    </motion.div>
                                )}
